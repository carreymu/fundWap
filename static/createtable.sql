...
INSERT INTO user_fund_account(real_name,risk_level,tax_id,trade_password,idcard_num) values('张翠花',1,1,'YadnSEWOdwO09uwFepOe====','110221199202235460','2033-12-02','上海市南京东西路xxx号',1)
...
INSERT INTO target(name,target_ratio,run_status) values('2006',0.08,1)
...
INSERT INTO target_funds(fid,amt,returns) values(1,2478.63,4.51)
...
INSERT INTO target_trade_process(uid,fid,tt_id,tid,status,confirm_fund_amt,confirm_date,pay_date) values(1,2,1,1,2,340.85,1,'2020-02-21','2020-02-25')--Lady Gaga-景顺长城沪深300增强-天弘弘运宝A-1-[大目标]1902-转换-转入237.36-转出
...
CREATE TABLE target_trade_process_details2(tthd2_id Integer primary key autoincrement,uid int,tid int,fid_in int,fid_out int,worth_out float,worth_in float,fund_portion_in float,fund_position_out float,charge_in float,charge_out float,
trade_status_in int,trade_status_out int,inserttime timestamp not null default (datetime('now','localtime')))
INSERT INTO target_trade_process_details2(uid,tid,fid_in,fid_out,worth_out,worth_in,fund_portion_in,fund_portion_out,charge_in,charge_out,trade_status_in,trade_status_out) values(1,1,1,2,1,1.0,1.26,188.3,237.26,0.00,0.00,1,1)
