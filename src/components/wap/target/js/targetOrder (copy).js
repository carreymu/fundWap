  ...
  export default {
    ...
    methods:{
      initSched(){
        ...
        this.schedInfo['startDate']=this.$utdate.dateFmt(sdate,"MM-dd")
        this.schedInfo['endDate']=this.$utdate.dateFmt(edate,"MM-dd")
        this.schedInfo['weekday']=weekday[(new Date(edate)).getDay()]
      },
      // initBank(){
      //   let dt = {
      //     "req": {"uid":this.uid},
      ...
      //       let w = r.user_bank_wapper[0]
      //       this.bankInfo["bank_name"] = w.bank_name
      //       this.bankInfo["policy"] = w.policy
      //       this.bankInfo["card_tail"] = w.card_tail
      //     }
