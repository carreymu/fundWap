...
config = dict(
    fund_plans={
      ...
      "sql_info": {
        ...
        "sql": {
          "mysql": "select fpl_id,fpc_id,name,profit_ratio,loss_ratio,profit_type,init_amt,sched_init_amt,"
    ...
    fund_plan_by_fplid={
        ...
        "sql_info": {
            "engine_name": "db_fund_wap_mysql",
            "sql": {
                "mysql": "select fpl_id,fpc_id,name,profit_ratio,loss_ratio,profit_type,init_amt,join_num,status,"
