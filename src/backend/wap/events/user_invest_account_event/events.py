    ...
    async def compute(self):
        ...
        if user_iv_acc_list:
            ...
            if user_iv_acc_list:
                ...
                my_invests.append(self.json_convert(user_iv_acc_list, 'tid', '大目标', dt))
                my_invests.append(self.json_convert(user_iv_acc_list, 'fpl_id', '优选', dt))
                my_invests.append(self.json_convert(user_iv_acc_list, 'did', '鸡腿计划', dt))
                my_invests.append(self.json_convert(user_iv_acc_list, 'fid', '基金', dt))
